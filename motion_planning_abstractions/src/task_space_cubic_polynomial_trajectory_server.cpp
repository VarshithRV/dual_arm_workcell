...
public:
    TSCubicPolynomialTraj()
    {
        ...
        print_state_server_ = node_->create_service<std_srvs::srv::Trigger>(
            "~/print_robot_state",
            std::bind(&TSCubicPolynomialTraj::print_state, this,
        ...
        pick_and_place_server_ =
            node_->create_service<motion_planning_abstractions_msgs::srv::Pick>(
                "~/pick_and_place",
                std::bind(&TSCubicPolynomialTraj::pick_and_place_server, this,
                          std::placeholders::_1, std::placeholders::_2),
                rmw_qos_profile_services_default,
                callback_group_);
        ...
        wrench_subscription_ = node_->create_subscription<geometry_msgs::msg::WrenchStamped>(wrench_topic_name,10,std::bind(&TSCubicPolynomialTraj::wrench_callback,this,std::placeholders::_1));
